        ...
        <div className="w-full flex flex-wrap gap-4 max-[500px]:gap-2">
            <div className="bg-gray-200 dark:bg-[#202124] min-[1085px]:rounded-xl relative flex-1 flex flex-col items-center gap-8 py-8 min-w-[260px]">
                ...
                <ul className="w-full flex flex-col justify-around select-none">
                    <li onClick={() => setTab("account")} className={`cursor-pointer flex gap-4 items-center p-3.5 px-[1.7rem] ${tab == "account" ? "bg-white dark:bg-[#28292d] text-black dark:text-white" : "hover:bg-gray-300 dark:hover:bg-[#28292d]/60 text-slate-500 dark:text-[#787881]"}`}><i className="fa-solid fa-house w-4"></i>My Account</li>
                    <li onClick={() => setTab("security")} className={`cursor-pointer flex gap-4 items-center p-3.5 px-[1.7rem] ${tab == "security" ? "bg-white dark:bg-[#28292d] text-black dark:text-white" : "hover:bg-gray-300 dark:hover:bg-[#28292d]/60 text-slate-500 dark:text-[#787881]"}`}><i className="fa-solid fa-key w-4"></i>Security</li>
                    <li onClick={() => setTab("notifications")} className={`cursor-pointer flex gap-4 items-center p-3.5 px-[1.7rem] ${tab == "notifications" ? "bg-white dark:bg-[#28292d] text-black dark:text-white" : "hover:bg-gray-300 dark:hover:bg-[#28292d]/60 text-slate-500 dark:text-[#787881]"}`}><i className="fa-solid fa-envelope w-4"></i>Notifications</li>
                </ul>
            </div>
