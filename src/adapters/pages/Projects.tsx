                        ...
                        <div className={`bg-slate-700 rounded-xl flex flex-col gap-4 p-4 w-9/12 ${selectedProject == "none" ? "!w-full" : ""}`}>
                            <div id="scrollbar" className="flex flex-col gap-4">
                                ...
                                <div className="selectProject">
                                    ...
                                    {/* TWO */}
                                    {
                                        selectedProject == "sergio" &&
                                        <div className="selectedProject" onClick={(event: React.MouseEvent<HTMLElement>) => { selectProject("sergio") }}>
                                            <Item title="sergio" description="nada más que comentar" tools={[
                                                {
                                                    action: "edit",
                                                    icon: "fa-solid fa-pen-to-square",
                                                    color: "bg-green-700",
                                        ...
                                        selectedProject != "sergio" &&
                                        <div onClick={(event: React.MouseEvent<HTMLElement>) => { selectProject("sergio") }}>
                                            <Item title="sergio" description="nada más que comentar" tools={[
                                                {
                                                    action: "edit",
                                                    icon: "fa-solid fa-pen-to-square",
