...
export function AchievementsLevel(props: {level: number, rank: string}) {
    return (
        <>
            ...
            <div className="flex flex-col items-center bg-slate-800 w-44 h-48 relative">
                <div className="achievementsLevel border-green-700 bg-inherit relative z-10">
                    <p className="text-base text-white leading-none">LEVEL</p>
                    <p className="text-5xl text-white leading-none"><b>{props.level}</b></p>
                </div>
                <div className="h-12 w-28 bg-green-700 rounded-b-2xl flex justify-center items-center absolute -bottom-2 z-0"></div>
