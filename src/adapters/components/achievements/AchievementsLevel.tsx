...
export function AchievementsLevel(props: {level: number, rank: string}) {
    return (
        <>
            ...
            <div className="flex flex-col items-center bg-slate-800 w-40 aspect-square relative">
                <div className="achievementsLevel border-green-400/70 bg-inherit relative z-10">
